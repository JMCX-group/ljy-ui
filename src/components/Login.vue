  ...
  <div id="login" class="login">
    <div class="div-centered">
      ...
      <div class="row">
        ...
        <div class="col-sm-1 col-xs-1 col-phone">
      ...
      <div class="row row-verify">
        <div class="col-sm-1 col-xs-1"></div>
        <div class="col-sm-1 col-xs-1 col-verify">
      ...
      <div class="row">
        <div class="col-sm-1 col-xs-1"></div>
        <div class="col-sm-11 col-xs-11 col-login">
  ...
  export default {
    ...
    methods: {
      ...
      userLogin() {
        ...
        this.$router.push({ path: '/with-tour' }) // 待接口调通，则放入then.后面执行
...
<style>
  #login {
    background: url("../assets/login/login_logo_bg.png") fixed center center no-repeat;
